...
void MeshSystem::Init(VulkanExampleBase *ex)
{
    example = ex;
...
void MeshSystem::loadglTFFile(std::string filename)
	{
...
glm::mat4 MeshSystem::updateViewMatrix()
	...
	void MeshSystem::updateUniformBuffers()
	{
...
void MeshSystem::prepareUniformBuffers()
	{
...
void MeshSystem::setupDescriptors()
	{
		/*
...
void MeshSystem::preparePipelines()
	{
...
void MeshSystem::buildCommandBuffers(){
...
void MeshSystem::InputListener(Event& event)
{
